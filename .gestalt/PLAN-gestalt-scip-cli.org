...
** DONE [#C] Implement SCIP file auto-discovery logic
   Effort: 2-3 hours
...
** DONE [#A] Implement symbols search command (matches /api/scip/symbols)
   Effort: 4-5 hours
...
** DONE [#A] Implement definition and references commands
   Effort: 3-4 hours
...
** DONE [#C] Implement files command (matches /api/scip/files/:path)
   Effort: 2 hours
