...
** DONE [#A] Wire up CLI with commander and build executable
   Effort: 3-4 hours
...
** DONE [#A] Add async SCIP indexing on gestalt startup with dashboard UI
   Effort: 5-6 hours
...
** DONE [#C] Add gestalt-scip to build and install workflows
   Effort: 2 hours
...
** DONE [#C] Write integration tests and documentation
   Effort: 3-4 hours
