...
* WIP [#A] Standalone gestalt-scip CLI tool for offline SCIP queries
  Effort: 2-3 days
...
** DONE [#A] Extract reusable SCIP modules from scip-typescript-finder
   Effort: 4-6 hours
...
** TODO [#A] Create cmd/gestalt-scip TypeScript project structure
   Effort: 3-4 hours
   ...
   2. package.json dependencies:
      ```json
      {
        ...
        "dependencies": {
          "commander": "^12.0.0",
          "scip-finder": "file:../../scip-typescript-finder"
        },
        "devDependencies": {
          "@types/node": "^20.0.0",
          "esbuild": "^0.20.0",
        ...
        "scripts": {
          "build": "tsc && esbuild dist/main.js --bundle --platform=node --outfile=bin/gestalt-scip --banner:js=\"#!/usr/bin/env node\"",
   ...
   3. tsconfig.json:
      ```json
      {
        "extends": "../../scip-typescript-finder/tsconfig.json",
        "compilerOptions": {
          "outDir": "./dist",
          "rootDir": "./src"
        },
   ...
   - Can import scip-finder lib modules

** TODO [#C] Implement SCIP file auto-discovery logic
   Effort: 2-3 hours
...
** TODO [#A] Implement symbols search command (matches /api/scip/symbols)
   Effort: 4-5 hours
...
** TODO [#A] Implement definition and references commands
   Effort: 3-4 hours
...
** TODO [#C] Implement files command (matches /api/scip/files/:path)
   Effort: 2 hours
...
** TODO [#A] Wire up CLI with commander and build executable
   Effort: 3-4 hours
...
** TODO [#A] Add async SCIP indexing on gestalt startup with dashboard UI
   Effort: 5-6 hours
...
** TODO [#C] Add gestalt-scip to build and install workflows
   Effort: 2 hours
...
** TODO [#C] Write integration tests and documentation
   Effort: 3-4 hours
