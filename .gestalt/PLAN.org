...
** TODO [#C] Re-evaluate tray icon support under Wails v3 (DEFER)
...
** WIP [#B] Add CI/CD workflow for desktop builds (optional)
...
** TODO [#C] Document desktop application usage
...
** TODO [#C] Add native window features (optional enhancements)
