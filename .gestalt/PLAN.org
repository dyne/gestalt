...
** TODO [#B] Extract internal/git helper
...
** TODO [#B] Isolate debounce and registration logic
...
** TODO [#C] Optional recursive watch and context-based interface
