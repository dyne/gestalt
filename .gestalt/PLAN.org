...
** DONE [#B] Update terminal session creation to use generated shell commands
...
** DONE [#C] Document new configuration system in docs/ and AGENTS.md
...
** DONE [#C] Add integration tests for full config validation workflow
...
** DONE [#C] Add CLI validation command for config files
...
** DONE [#A] Update default agent configs to use TOML with cli_config
...
** WIP [#B] Store agent config and hash in Temporal workflow memo
