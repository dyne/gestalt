...
** TODO [#A] Reuse prompt resolver for agent prompt validation
...
** TODO [#A] Use encoding/xml.EscapeText for SKILL XML
...
** TODO [#B] Case-fold agent name uniqueness (if desired)
...
** TODO [#B] Shared loader/path normalization helper
