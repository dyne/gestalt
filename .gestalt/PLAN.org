...
** DONE [#B] Split Session into focused sub-structs
...
** DONE [#B] Align buffer retention semantics across logs/terminal
...
** WIP [#C] Introduce SessionFactory and output publisher
