* WIP [#A] Config extraction refactor with hash verification and version tracking
...
** [#B] Research and design version.json and manifest formats
   ...
   - Manifest format: JSON object of config-relative path -> sha256 hex (file bytes)
   ...
   - Example manifest.json: {"agents/copilot.json":"<sha256>","skills/core/SKILL.md":"<sha256>"}
...
** DONE [#B] Switch config hash algorithm to FNV-1a 64
...
** DONE [#C] Add developer mode for config override
...
** DONE [#B] Add integration tests for config extraction flow
...
** DONE [#B] Document upgrade path and version compatibility
...
** DONE [#C] Add telemetry for config extraction metrics
