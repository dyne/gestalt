...
** TODO [#A] Refactor desktop app for Wails v3 API changes
...
** TODO [#C] Re-evaluate tray icon support under Wails v3
...
** TODO [#C] Test desktop app functionality end-to-end
...
** TODO [#B] Add CI/CD workflow for desktop builds (optional)
