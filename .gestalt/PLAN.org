...
** [#B] Research Wails v2 architecture and implementation patterns
...
** [#B] Install Wails v2 CLI and create skeleton project for study
...
** [#B] Create cmd/gestalt-desktop with Wails integration
...
** [#B] Configure frontend build for Wails desktop mode
...
** [#B] Create wails.json configuration
...
** [#B] Implement Wails bindings for core operations
...
** [#B] Update frontend API client for Wails compatibility
...
** [#B] Wire embedded server into desktop app lifecycle
...
** [#B] Integrate Makefile build targets for desktop
...
** [#C] Add desktop-specific window configuration
...
** [#C] Add desktop-specific native menus (optional)
...
** [#C] Handle desktop-specific file paths and resources
...
** [#C] Add system tray icon (optional enhancement)
...
** [#A] Upgrade to Wails v3 tooling and configuration
...
** [#A] Refactor desktop app for Wails v3 API changes
...
** [#C] Re-evaluate tray icon support under Wails v3 (DEFER)
...
** [#C] Test desktop app functionality end-to-end
...
** [#B] Add CI/CD workflow for desktop builds (optional)
...
** [#C] Document desktop application usage
...
** [#C] Add native window features (optional enhancements) (DEFER)
