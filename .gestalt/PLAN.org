...
* WIP [#B] Strip ANSI escape sequences and noise from log context fields
  Effort: 1-2 days
...
** DONE [#B] Create ANSI/control code filter utility
   Effort: 3-4 hours
...
** DONE [#B] Apply filter to output_tail in terminal manager
   Effort: 1-2 hours
...
** DONE [#B] Apply filter to bell context in Temporal activities
   Effort: 1 hour
...
** DONE [#B] Apply filter to stderr in session factory
   Effort: 30 minutes
...
** DONE [#B] Add integration test for WebSocket log stream filtering
   Effort: 2-3 hours
...
** DONE [#C] Add performance benchmarks for text filtering
   Effort: 1-2 hours
...
** TODO [#C] Update documentation for filtered logs
   Effort: 30 minutes
