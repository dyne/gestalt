...
** DONE [#B] Research and design version.json and manifest formats
...
** DONE [#B] Create build-time manifest and version generator
...
** DONE [#B] Embed manifest and version metadata
...
** DONE [#B] Implement hash verification logic
...
** DONE [#A] Implement version compatibility checking
...
** DONE [#B] Integrate version tracking and extraction into startup
...
** DONE [#C] Handle backup file cleanup policy
...
** DONE [#B] Relocate PLAN.org to .gestalt/PLAN.org
...
** DONE [#C] Add migration helper for existing installations
...
** DONE [#C] Update --extract-config flag behavior
...
** DONE [#B] Update documentation for new config behavior
...
** DONE [#B] Add config validation on extraction
...
** DONE [#C] Optimize extraction performance
...
** DONE [#B] Expose version info in API and logs
...
** DONE [#B] Update frontend for .gestalt/PLAN.org
