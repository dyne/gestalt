...
** TODO [#A] Identify root cause via code inspection
   Effort: 2-3 hours
...
** TODO [#A] Capture and analyze baseline CPU profile
   Effort: 1-2 hours
...
** TODO [#A] Fix identified CPU hotspot
...
** TODO [#B] Verify CPU usage fix with profiling
   Effort: 1 hour
...
** TODO [#B] Add regression coverage for idle CPU behavior
   Effort: 2-4 hours
   Change:
