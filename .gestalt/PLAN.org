...
* WIP [#A] API and WebSocket consolidation
...
** DONE [#A] Create backend WS upgrade/write helper
...
** DONE [#A] Add wsAuth helper for token validation
...
** DONE [#A] Move JSON helpers out of rest.go
...
** TODO [#B] Add terminal route parsing helpers
...
** TODO [#B] Standardize WS error wrapper
...
** TODO [#C] Introduce domain routers or WS stream abstraction
