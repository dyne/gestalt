...
** DONE [#C] Implement codex shell command generation from cli_config
...
** DONE [#C] Implement copilot shell command generation from cli_config
...
** DONE [#B] Add config refresh before terminal session start
...
** WIP [#B] Update terminal session creation to use generated shell commands
