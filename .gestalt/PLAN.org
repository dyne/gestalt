* WIP [#B] Port templating directives for runtime service discovery
  Effort: 2-3 days
...
** WIP [#B] Design port registry and resolver interface
   Effort: 2-3 hours
...
** TODO [#B] Extend prompt parser to accept PortResolver
   Effort: 3-4 hours
...
** TODO [#B] Implement port directive resolution in render loop
   Effort: 2-3 hours
...
** TODO [#B] Populate port registry at server startup
   Effort: 3-4 hours
...
** TODO [#B] Wire port resolver into prompt rendering flow
   Effort: 2-3 hours
...
** TODO [#C] Add tests for port directive rendering
   Effort: 2-3 hours
...
** TODO [#C] Document port directive syntax and available services
   Effort: 1-2 hours
...
** TODO [#C] Add example prompt using port directives
   Effort: 1 hour
   ...
   - Content: API documentation referencing {{port backend}}
   - Example: "Backend API: http://localhost:{{port backend}}/api/status"
   - Example: "Temporal UI: http://localhost:{{port temporal}}"
   - Example: "OpenTelemetry: http://localhost:{{port otel}}/v1/logs"
...
** TODO [#C] Consider adding port directive to skill XML (future)
