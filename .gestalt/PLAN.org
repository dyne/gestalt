...
** TODO [#B] Create internal/scip package with SQLite query layer
...
** TODO [#B] Implement indexer downloader and language detection
...
** TODO [#B] Add REST API endpoints for SCIP queries
...
** TODO [#B] Create agent prompt/skill documenting SCIP API usage
...
** TODO [#C] Add indexing command to gestalt CLI
...
** TODO [#C] Optimize query performance and add caching
