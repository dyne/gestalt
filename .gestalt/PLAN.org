* WIP [#A] OpenTelemetry observability migration
  Effort: 2-3 weeks
...
** DONE [#A] Research and design OpenTelemetry integration architecture
** DONE [#B] Build custom OpenTelemetry Collector binary with ocb
** DONE [#B] Implement Collector lifecycle management in Gestalt
** DONE [#B] Integrate Collector start into Temporal workflow
** DONE [#A] Add OpenTelemetry SDK to Gestalt Go backend
** DONE [#A] Add comprehensive API instrumentation with agent-specific metrics
   Effort: 2-3 days
...
** DONE [#A] Migrate internal/logging to OpenTelemetry LogRecords
** DONE [#B] Migrate event.Bus events to OpenTelemetry LogRecords
** DONE [#B] Add distributed tracing for WebSocket connections
** DONE [#B] Integrate OpenTelemetry with Temporal workflows
** DONE [#A] Replace internal/metrics with OpenTelemetry metrics
** DONE [#B] Create frontend OTel query client
** DONE [#B] Update LogsView to use OpenTelemetry logs
