* WIP [#B] CLI-specific agent configuration with TOML format and schema validation
...
** DONE [#B] Add invopop/jsonschema dependency and create schema infrastructure
...
** DONE [#B] Implement codex configuration schema from codex-config-mod.rs
...
** DONE [#C] Implement copilot configuration schema
...
** DONE [#B] Extend Agent struct to support cli_config and TOML format
...
** DONE [#B] Update agent loader to support TOML files with proper validation
