...
* WIP [#A] Terminal/session and logging cleanup
...
** DONE [#A] Extract AsyncFileLogger for session + input logs
...
** DONE [#A] Extract prompt injection helper
...
** DONE [#A] Add session lifecycle helper for logging/events
...
** DONE [#B] Add explicit Windows PTY error message
...
** WIP [#B] Split Session into focused sub-structs
...
** TODO [#B] Align buffer retention semantics across logs/terminal
...
** TODO [#C] Introduce SessionFactory and output publisher
