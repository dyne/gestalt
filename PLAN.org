...
** DONE [#B] Create backend endpoint to serve PLAN.org
...
** DONE [#B] Create org-mode parser for outline structure
...
** DONE [#B] Create OrgViewer Svelte component
...
** DONE [#B] Create OrgNode component for heading rendering
...
** DONE [#C] Add expand/collapse controls
...
** DONE [#C] Add search functionality (optional)
...
** DONE [#B] Integrate OrgViewer into dashboard
...
** DONE [#C] Polish styling and responsiveness
