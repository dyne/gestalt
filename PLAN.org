* WIP [#A] Event-based filesystem monitoring with WebSocket notifications
...
** DONE [#B] Evaluate and add fsnotify dependency
...
** DONE [#B] Create internal/watcher package structure
