...
** DONE [#B] Design pointer-based scroll architecture
...
** DONE [#B] Implement pointer event handlers with type detection
...
** DONE [#B] Integrate pointer scroll into attach/detach lifecycle
...
** DONE [#C] Add CSS touch-action: none to xterm element
...
** DONE [#B] Calculate scroll sensitivity (deltaY to scrollLines conversion)
...
** DONE [#B] Add scroll activation threshold to prevent accidental scrolling
...
** DONE [#B] Preserve xterm text selection for mouse
...
** DONE [#B] Test on real touch devices (phone, tablet)
...
** DONE [#C] Add inertial touch scrolling (optional)
...
** DONE [#C] Add visual feedback for touch scroll (optional)
...
** DONE [#B] Add touch scroll integration tests (automated)
...
** DONE [#B] Update documentation for touch scroll feature
...
** DONE [#C] Tune inertial scroll feel (duration + additive momentum)
...
** DONE [#B] Preserve scrollbar drag behavior on touch
...
** DONE [#A] Validate with user testing before marking done
