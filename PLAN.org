* TODO [#B] Improve CLI tools with proper flags and help
...
** TODO [#B] Define consistent CLI flag structure and conventions
...
** TODO [#B] Add flag package and help infrastructure to gestalt
...
** TODO [#B] Implement comprehensive --help for gestalt
...
** TODO [#B] Add --version flag to gestalt
...
** TODO [#B] Refactor gestalt-send to use consistent flag naming
...
** TODO [#B] Implement comprehensive --help for gestalt-send
...
** TODO [#B] Add --version flag to gestalt-send
...
** TODO [#B] Create gestalt-desktop CLI with same flag structure
...
** TODO [#C] Add shell completion subcommand to gestalt
...
** TODO [#C] Add verbose/debug logging flags to gestalt
...
** TODO [#B] Add CLI flag parsing tests
...
** TODO [#B] Update README with CLI flag documentation
...
** TODO [#C] Consider migrating to cobra for richer CLI (future)
