* WIP [#A] Unified event architecture with generic event bus
...
** DONE [#A] Design unified event bus architecture
...
** DONE [#B] Create internal/event package with generic Bus implementation
...
** DONE [#B] Create typed event interfaces and base types
...
** DONE [#B] Add filtered subscription support
...
** DONE [#B] Migrate watcher EventHub to generic event bus
...
** DONE [#B] Migrate terminal Broadcaster to generic event bus
...
** DONE [#B] Migrate logging to generic event bus
...
** DONE [#B] Add agent lifecycle events
...
** DONE [#B] Add terminal lifecycle events
...
** DONE [#B] Add config change events for future config refactor
...
** DONE [#C] Add workflow state events for Temporal integration
...
** DONE [#B] Add event bus metrics and monitoring
...
** DONE [#B] Create event bus testing utilities
...
** DONE [#C] Add event replay and debugging features
...
** DONE [#B] Update documentation for event-driven architecture
...
** DONE [#B] Add integration tests for event flows
...
** DONE [#B] Deprecate old event implementations
...
** DONE [#C] Performance optimization and benchmarking
