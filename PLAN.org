* WIP [#B] UI/UX polish and visual identity improvements
...
** WIP [#C] Remove unused Tailwind CSS dependency
...
** TODO [#C] Add human-readable timestamp formatting utility
...
** TODO [#C] Apply human-readable timestamps throughout UI
...
** TODO [#C] Change agent terminal buttons to start or switch (remove stop action)
...
** TODO [#C] Remove close (X) buttons from terminal tabs
...
** TODO [#B] Add close button with confirmation dialog to terminal view
...
** TODO [#C] Download and add Dyne.org logo assets
...
** TODO [#C] Copy Gestalt typography logo to assets
...
** TODO [#C] Replace notifications button with Dyne.org logos in header
...
** TODO [#C] Replace "Gestalt" text title with typography logo
...
** TODO [#C] Rename "Flow" tab to "Status"
