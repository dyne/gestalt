...
** DONE [#B] Isolate dev proxy per instance
...
** DONE [#B] Fix make dev shell compatibility
   ...
   Done when: `GESTALT_PORT=9090 make dev` runs without shell errors

** DONE [#B] Remove deprecated EventHub wrapper
