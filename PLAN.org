* WIP [#B] Improve CLI tools with proper flags and help
...
** DONE [#B] Define consistent CLI flag structure and conventions
...
** DONE [#B] Add flag package and help infrastructure to gestalt
...
** DONE [#B] Implement comprehensive --help for gestalt
...
** DONE [#B] Add --version flag to gestalt
...
** DONE [#B] Refactor gestalt-send to use consistent flag naming
...
** DONE [#B] Implement comprehensive --help for gestalt-send
...
** DONE [#B] Add --version flag to gestalt-send
...
** DONE [#B] Create gestalt-desktop CLI with same flag structure
...
** DONE [#C] Add shell completion subcommand to gestalt
...
** DONE [#C] Add verbose/debug logging flags to gestalt
