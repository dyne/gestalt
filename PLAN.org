* WIP [#B] Prompt templating system with include directives
...
** DONE [#C] Research and decide include directive syntax
...
** DONE [#C] Create prompt template parser module
...
** DONE [#C] Integrate template parser into terminal manager with file list logging
...
** DONE [#C] Display prompt file list in agent terminal header
...
** DONE [#B] Comprehensive test coverage for prompt templating
