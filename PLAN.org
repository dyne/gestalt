...
** DONE [#C] Stop terminal-created toasts and log the event
...
** WIP [#C] Restore dashboard running-state styling
...
** TODO [#B] Move terminal close control into terminal header
...
** TODO [#C] Fix header logo asset loading
