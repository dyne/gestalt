...
* WIP [#A] Fix frontend bugs following user driven testing feedback
  Goal: create a smooth pipeline straightening all bugs encountered by a user testing gestalt

** DONE [#B] Preserve terminal screen buffer across tab switches
