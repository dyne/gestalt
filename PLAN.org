...
** DONE [#C] Remove unused Tailwind CSS dependency
...
** DONE [#C] Add human-readable timestamp formatting utility
...
** DONE [#C] Apply human-readable timestamps throughout UI
...
** DONE [#C] Change agent terminal buttons to start or switch (remove stop action)
...
** DONE [#C] Remove close (X) buttons from terminal tabs
...
** WIP [#B] Add close button with confirmation dialog to terminal view
