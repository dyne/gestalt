...
** DONE [#C] Replace notifications button with Dyne.org logos in header
...
** DONE [#C] Replace "Gestalt" text title with typography logo
...
** WIP [#C] Rename "Flow" tab to "Status"
