* TODO [#A] Event-based filesystem monitoring with WebSocket notifications
...
** TODO [#B] Evaluate and add fsnotify dependency
...
** TODO [#B] Create internal/watcher package structure
...
** TODO [#B] Implement core Watcher with fsnotify integration
...
** TODO [#B] Add event hub for centralized event management
...
** TODO [#B] Implement WebSocket /ws/events endpoint
...
** TODO [#B] Implement PLAN.org file watching
...
** TODO [#B] Update PlanView to use WebSocket events
...
** TODO [#B] Implement git branch monitoring
...
** TODO [#B] Add git origin and branch to /api/status
...
** TODO [#B] Update Dashboard to show git branch live
...
** TODO [#C] Add configurable watcher limits and cleanup
...
** TODO [#C] Add debouncing and event coalescing
...
** TODO [#C] Add frontend WebSocket event store
...
** TODO [#C] Add error handling and recovery
...
** TODO [#C] Add integration tests for end-to-end event flow
...
** TODO [#C] Document event system and usage patterns
