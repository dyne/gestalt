* TODO [#A] Unified event architecture with generic event bus
...
** TODO [#A] Design unified event bus architecture
...
** TODO [#B] Create internal/event package with generic Bus implementation
...
** TODO [#B] Create typed event interfaces and base types
...
** TODO [#B] Add filtered subscription support
...
** TODO [#B] Migrate watcher EventHub to generic event bus
...
** TODO [#B] Migrate terminal Broadcaster to generic event bus
...
** TODO [#B] Migrate logging to generic event bus
...
** TODO [#B] Add agent lifecycle events
...
** TODO [#B] Add terminal lifecycle events
...
** TODO [#B] Add config change events for future config refactor
...
** TODO [#C] Add workflow state events for Temporal integration
...
** TODO [#B] Add event bus metrics and monitoring
...
** TODO [#B] Create event bus testing utilities
...
** TODO [#C] Add event replay and debugging features
...
** TODO [#B] Update documentation for event-driven architecture
...
** TODO [#B] Add integration tests for event flows
...
** TODO [#B] Deprecate old event implementations
...
** TODO [#C] Performance optimization and benchmarking
...
** TODO [#A] Validate event architecture before config refactor
...
* TODO [#B] Fix terminal natural touch scrolling
...
** TODO [#A] Research and analyze why current touch scroll fails
...
** TODO [#B] Choose between Touch Events vs Pointer Events API
...
* TODO [#A] Config extraction refactor with hash verification and version tracking
