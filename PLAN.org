...
* TODO [#B] Multi-prompt injection on agent startup
  ...
  - Maintain backward compatibility not needed: drop "prompt_file"
...
** TODO [#B] Update Agent struct to support prompt array
...
** TODO [#B] Update agent loader to resolve prompt names to paths
...
** TODO [#B] Implement sequential prompt injection in session startup
...
** TODO [#C] Update example agent configs to use new format
...
** TODO [#C] Update documentation for prompt configuration
