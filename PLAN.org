...
** DONE [#B] Add close button with confirmation dialog to terminal view
...
** DONE [#C] Download and add Dyne.org logo assets
...
** DONE [#C] Copy Gestalt typography logo to assets
...
** WIP [#C] Replace notifications button with Dyne.org logos in header
