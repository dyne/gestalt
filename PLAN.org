* WIP [#B] Agent Skills integration
...
** DONE [#B] Create skill data structure and parser
...
** DONE [#B] Implement skill loader from config/skills/
...
** DONE [#B] Wire skill loader into Manager initialization
...
** DONE [#B] Extend agent profiles to reference skills
...
** DONE [#C] Generate skill metadata for agent prompts
...
** DONE [#B] Inject skill metadata into agent prompts
...
** DONE [#C] Add GET /api/skills endpoint
...
** DONE [#C] Add GET /api/skills/:name endpoint
...
** DONE [#C] Create example skills in config/skills/
...
** DONE [#C] Update frontend to display skills
...
** DONE [#C] Document Agent Skills integration
...
** DONE [#C] Add skill validation CLI command (optional)
...
** DONE [#C] Consider script execution security (future)
