...
** [#A] Create wsStore helper for event stores
...
** [#A] Extract CommandInput history helper
...
** [#A] Extract PlanView polling fallback helper
...
** [#A] Document frontend data flow and store ownership
...
** [#B] Add a thin routing helper for tabs
...
** [#B] Introduce shared API client layer
...
** [#B] Move Dashboard orchestration into a store
...
** [#B] Standardize view loading/error UI patterns
...
** [#B] Share workflow formatting helpers
...
** [#C] Split terminalStore into service + store
...
** [#C] Optional routing/state machine per view
...
** [#B] Add optional SCIP build tags
...
** [#C] Document SCIP build tag usage
