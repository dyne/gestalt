...
** DONE [#A] Create wsStore helper for event stores
...
** DONE [#A] Split Terminal component
...
** DONE [#A] Extract CommandInput history helper
...
** DONE [#A] Extract PlanView polling fallback helper
...
** DONE [#A] Document frontend data flow and store ownership
...
** DONE [#B] Add a thin routing helper for tabs
...
** DONE [#B] Introduce shared API client layer
...
** DONE [#B] Move Dashboard orchestration into a store
...
** DONE [#B] Standardize view loading/error UI patterns
...
** DONE [#B] Share workflow formatting helpers
...
** DONE [#C] Split terminalStore into service + store
...
** WIP [#C] Optional routing/state machine per view
