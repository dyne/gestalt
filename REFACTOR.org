...
** DONE [#A] Add terminal DSR/backpressure tests
...
** DONE [#A] Add watcher restart/backoff tests
...
** DONE [#B] Add CLI error mapping tests
...
** DONE [#B] Add frontend coverage workflow
