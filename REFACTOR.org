...
* TODO [#A] API and WebSocket consolidation
...
** TODO [#A] Create backend WS upgrade/write helper
...
* TODO [#A] Agent and skill loader consistency
...
** TODO [#A] Document Agent.Validate side-effects
...
** TODO [#A] Standardize REST error field names
...
** TODO [#B] Centralize frontend error handling
...
** TODO [#A] Add WS close/error path tests
...
** TODO [#A] Add terminal DSR/backpressure tests
...
** TODO [#A] Add watcher restart/backoff tests
...
** TODO [#B] Add CLI error mapping tests
...
** TODO [#B] Add frontend coverage workflow
...
** TODO [#B] Add API/WS integration tests for structured errors
...
** TODO [#B] Add Terminal/CommandInput component tests
...
** TODO [#A] Move prompt validation helper
...
** TODO [#B] Split main.go into focused files
...
** TODO [#B] Introduce internal app builder
...
** TODO [#C] Command struct pattern for subcommands
...
** TODO [#A] Centralize sendError handling
...
** TODO [#B] Extract HTTP client helpers
...
** TODO [#B] Formalize agent cache format
...
** TODO [#C] Shared CLI framework for gestalt + gestalt-send
...
** TODO [#A] Create wsStore helper for event stores
