...
// ValidationError describes a schema validation mismatch.
...
// ValidateValue validates an arbitrary value against the provided schema.
func ValidateValue(schema *jsonschema.Schema, value any) error {
	return validateSchema(schema, value, "")
}

// ValidateObject validates an object value against the provided schema.
func ValidateObject(schema *jsonschema.Schema, value map[string]any) error {
	return validateSchema(schema, value, "")
}
...
func validateObject(schema *jsonschema.Schema, object map[string]any, path string) error {
